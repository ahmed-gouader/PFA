            ...
            <ul>
                <li>
                    <a href="index.php">
                        ...
                        <span class="title"><h1 class="animate__animated animate__heartBeat">PIRGCN</h1></span>
                    </a>
                </li>
                <li>
                    <a href="index.php">
                ...
                <li>
                    <a href="WIKI-HELP.html">
                        ...
                        <span class="title">Articles</Article></span>
                    </a>
                </li>
                <li>
                    <a href="meteo.html">
                        ...
                        <span class="title">Alerte Méteo</span>
                    </a>
                </li>
                <li>
                    <a href="maps.html">
                ...
                <li>
                <a onclick="sshowAlert()" href="#">

                        <span class="icon">
                        <ion-icon name="paper-plane-outline"></ion-icon>
                        </span>
                        <span class="title">Alertez</span>
                    </a>
                </li>
...
<div style="margin-top: 69%;">
        ...
        <img src="./img/protc.jpeg" alt="" width="70px" style="margin-left: 20%;">
        <div style="width: 100%; height: 100%; background-color: #ffff; margin-left: 5%%;   text-align: center;" >
        <h1 style="font-size:25px"> PLATEFORME INTÉGRÉE DE RECHERCHE EN GESTION DES CATASTROPHES NATURELLES</h1>
        </div>
        <img src="tunisia-flag-gif.gif" alt="Animated GIF" width="150px" height="80px" style="border-radius: 10px;">
        ...
        <div class="main">
            <div class="topbar">
                ...
                <div class="search">
                    <label>
                        <input type="text" name="q" placeholder="chercher en google scholar" >
 ...
 <div class="card1">
     ...
     <div id="weather-emoji"></div>
      ...
      <div class="pourcen" style="width: 80%; height: 50%;">
        <div style="width: 35%;">
        <canvas id="pieChart"></canvas>
            ...
            <div class="pour">
      <div class="pourcen">
        <h2 style="text-align: center; color : red;">Nombre de décès dus aux catastrophes en tunisie</h2>
...
<div class="pourcen">
<div class="slider1">
<h2 style="text-align: center; color : red;">Nombre annuel de décès dus à différents types de catastrophes naturelles en Afrique</h2>
    ...
    <div class="slides1">
     ...
     <iframe src="https://ourworldindata.org/explorers/natural-disasters?tab=map&time=2024&region=Africa&facet=none&Disaster+Type=Floods&Impact=Deaths&Timespan=Decadal+average&Per+capita=false&country=~OWID_WRL&hideControls=true" loading="lazy" style="width: 100%; height: 600px; border: 0px none;" allow="web-share; clipboard-write"></iframe>        </div>        <div class="iframe-container">
        ...
        <button class="custom-next" onclick="sslide()">></button>
             ...
             <div class="pour">
  <div class="pourcen">
    <h2 style="text-align: center; color : red;">Catastrophes naturelles signalées dans le monde, par type, 1970 à 2024</h2>
  ...
  <div class="pour">
            <div class="pourcen">
                    <div class="cardHeader">
                        <h2 style="text-align: center;">Analyse Mondiale des Catastrophes Naturelles : Impact Humain et Géographique</h2>
                    </div>
            ...
            <div class="pour">
            <div class="pourcen">
            <h2 style="color: red;">Répartition des Catastrophes Naturelles par Continent : Une Analyse en Pourcentage en 2023</h2>
...
<div class="footer__addr">
    <h1 class="footer__logo"><img src="./img/protc.jpeg" alt="" style="width: 100px; height: 100px; border-radius: 50%;"></h1>
    <h2>Contact</h2>
    <div style="font-size: large; color: red;"><ion-icon name="call-outline"></ion-icon>198</div>
    <address>
        Rue Des Emeraudes, تونس · 23 km<br>
      <a class="footer__btn" href="mailto:example@gmail.com">Email </a>
    </address>
  </div>
  <ul class="footer__nav">
    <li class="nav__item">
      <h2 class="nav__title">Récompenses</h2>
      <ul class="nav__ul">
        <li>
        ...
        <li>
          <a href="#">Gérer le compte</a>
        </li>
      </ul>
    </li>
    <li class="nav__item">
      <h2 class="nav__title">Actualités & Infos</h2>
      <ul class="nav__ul">
        <li>
          <a href="#">Communiqués de presse</a>
        </li>
        <li>
          <a href="#">À propos de nos produits</a>
        </li>
        <li>
          <a href="#">Support produit</a>
        </li>
        <li>
          <a href="#">Manuels de produits</a>
        </li>
        <li>
          <a href="#">Enregistrement de produits</a>
        </li>
        <li>
    ...
    <li class="nav__item">
        <img src="tunisia-flag-gif.gif" alt="Animated GIF" width="200px" height="100px" style="border-radius: 10px;">

      </li>
  </ul>
  
  <div class="legal">
    <p style="text-align: center;">&copy; 2024 Copyright.</p>
  </div>
</footer>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var data = {
        labels: ['Monde', 'Afrique', 'Tunisie'],
        datasets: [{
            label: 'Nombre de recherches scientifiques',
            data: [3380000,1500000 ,55800 ], // Exemple de données
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)'
    ...
    var pieChart = new Chart(pieCtx, {
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'Les Recherches scientifiques en Gestion des Catastrophes Naturelles'
                }
            }
        }
    });
